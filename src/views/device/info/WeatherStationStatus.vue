<template>
    <el-dialog :title="device.deviceName" v-model="dialogVisible" width="750px" append-to-body>
      <template #title>
        {{ device.deviceName }} 
        <el-tag
          :type="currentStatus === 'online' ? 'success' : currentStatus === 'fault' ? 'danger' : 'info'"
        ...
        <div class="weather-data">
          <div class="data-list">
            <div
              ...
              :key="item.label"
              :class="['custom-data-tag', item.bgClass, item.borderClass]"
            >
          ...
          <!-- 日期显示 -->
          <div class="data-date">
            数据时间：<span v-if="deviceData.collectTime || deviceData.updateTime">{{ formatDateTime(deviceData.collectTime || deviceData.updateTime) }}</span>
...
import {
  ...
  Coin, Watermelon, Sugar, Flag, Star
...
function formatDateTime(val: string | undefined): string {
  ...
  /* 背景色 */
  .data-bg-danger { background: #ffeaea !important; }
  .data-bg-success { background: #eafaf3 !important; }
  .data-bg-primary { background: #e0f7fa !important; }
  .data-bg-warning { background: #fff9e1 !important; }
  .data-bg-info { background: #e3f2fd !important; }
  .data-bg-light { background: #e1f5fe !important; }

  /* 主色 */
  .data-color-danger { color: #ff7675 !important; background-color: #ff7675 !important; }
  .data-color-success { color: #00b894 !important; background-color: #00b894 !important; }
  .data-color-primary { color: #00bcd4 !important; background-color: #00bcd4 !important; }
  .data-color-warning { color: #fbc02d !important; background-color: #fbc02d !important; }
  .data-color-info { color: #42a5f5 !important; background-color: #42a5f5 !important; }
  .data-color-light { color: #29b6f6 !important; background-color: #29b6f6 !important; }
  ...
  .data-bg-orange { background: #fff7ec !important; }
  .data-bg-yellow { background: #fffde7 !important; }
  .data-bg-green { background: #eafaf3 !important; }
  .data-bg-blue { background: #e3f2fd !important; }
  .data-bg-purple { background: #f3e8fd !important; }
  .data-color-orange { background: #e67e22 !important; }
  .data-color-yellow { background: #f1c40f !important; }
  .data-color-green { background: #27ae60 !important; }
  .data-color-blue { background: #2980b9 !important; }
  .data-color-purple { background: #8e44ad !important; }
  .data-border-orange { border-color: #e67e22 !important; }
  .data-border-yellow { border-color: #f1c40f !important; }
  .data-border-green { border-color: #27ae60 !important; }
  .data-border-blue { border-color: #2980b9 !important; }
  .data-border-purple { border-color: #8e44ad !important; }
  .data-date {
    color: #999;
    font-size: 14px;
    margin-top: 32px;
