        ...
        <div>
          <div class="dialog-header">
            ...
            <div class="header-buttons">
              <el-button type="primary" @click="showAddDialog">
                <el-icon class="icon-with-margin"><Plus /></el-icon> 新建
              </el-button>
              <el-button type="danger" @click="deleteSelectedThresholds" :disabled="!hasSelected || hasSelectedChanged">
                <el-icon class="icon-with-margin"><Delete /></el-icon> 删除
              </el-button>
            </div>
          </div>
          <el-table ref="tableRef" :data="thresholds" style="width: 100%" @selection-change="handleSelectionChange">
              ...
              <template #default="{ row, $index }">
                <template v-if="editingUnitIndex === $index">
                  <el-input
                    ...
                    size="small"
                    @blur="stopEditUnit"
                    @keydown="(e) => handleUnitKeydown(e as KeyboardEvent)"
                    autofocus
                  />
                </template>
                <template v-else>
            ...
            <el-table-column prop="alarmLevel" label="报警级别" width="120">
              <template #default="{ row }">
                <el-select v-model="row.alarmLevel" placeholder="请选择" style="width: 100px">
            ...
            <el-table-column prop="notifyType" label="通知方式" width="140">
              <template #default="{ row }">
                <el-select v-model="row.notifyType" placeholder="请选择" style="width: 120px">
              ...
              <template #default="{ row, $index }">
                <template v-if="editingRemarkIndex === $index">
                  <el-input
                    ...
                    size="small"
                    @blur="stopEditRemark"
                    @keydown="(e) => handleRemarkKeydown(e as KeyboardEvent)"
                    autofocus
                  />
                </template>
                <template v-else>
          ...
          <div class="dialog-footer" style="display:flex;justify-content:flex-end;gap:12px;margin-top:24px;">
            <el-button
              ...
              type="primary"
              @click="onSaveSensorCommand"
            >保存</el-button>
            <el-button v-if="activeTab === 'threshold' && changedRowsCount > 0"
              type="primary"
              @click="changedRowsCount === 1 ? saveSelected() : saveAll()"
            >{{ changedRowsCount === 1 ? '保存' : '全部保存' }}</el-button>
          ...
          <el-dialog v-model="addDialogVisible" title="新建阈值配置" width="500px" append-to-body>
            <el-form ref="addFormRef" :model="newThreshold" :rules="rules" label-width="100px">
              <el-form-item label="参数类型" prop="paramType">
                <el-select v-model="newThreshold.paramType" placeholder="请选择参数类型" @change="onParamTypeDropdownVisible">
              ...
              <el-form-item label="阈值范围">
                <el-col :span="11">
                  <el-form-item prop="thresholdMin">
                    <el-input-number v-model="newThreshold.thresholdMin" :precision="2" :step="0.1" placeholder="最小值" />
                  </el-form-item>
                </el-col>
                <el-col :span="2" class="text-center">-</el-col>
                <el-col :span="11">
                  <el-form-item prop="thresholdMax">
                    <el-input-number v-model="newThreshold.thresholdMax" :precision="2" :step="0.1" placeholder="最大值" />
                  </el-form-item>
                </el-col>
              </el-form-item>
        ...
        <div class="tab-content-center">
          <el-form :model="mqttForm" :rules="mqttRules" ref="mqttFormRef" label-width="140px" class="mqtt-form">
            ...
            <el-form-item label="MQTT用户名" prop="mqtt_username">
              <el-input
                v-model="mqttForm.mqttUsername"
                autocomplete="off"
                name="mqtt-username-random"
              />
            </el-form-item>
            <el-form-item label="MQTT密码" prop="mqtt_password">
              <el-input
                v-model="mqttForm.mqttPassword"
                type="password"
                show-password
